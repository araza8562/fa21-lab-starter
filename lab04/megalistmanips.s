# Author: Ahmed Raza
# Description: This RISC-V assembly code implements a function called "map" that applies a given function to each element of a linked list of arrays. It also includes auxiliary functions for creating a default linked list and printing the lists before and after applying the map function. The "map" function iterates through each node of the list, applies the provided function to each element of the node's array, and updates the array with the result.
...
mapLoop:
    ...
    slli t3, t0, 2      # t3 = t0 * 4 (byte offset)
    add t1, t1, t3      # offset the array address by the count
    lw a0, 0(t1)        # load the value at that address into a0

    jalr s1             # call the function on that value.

    lw t1, 0(s0)        # reload the address of the array
    add t1, t1, t3      # offset the array address by the count
